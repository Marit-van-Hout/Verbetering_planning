...
from synthesizing import charging
...
if check_route_continuity(uploaded_file):
    # Voer de simulatie uit
    final_battery = simulate_battery(uploaded_file, actual_capacity, starting_time, end_time)
...
# Voer de simulatie uit
simulate_battery(uploaded_file, actual_capacity, starting_time, end_time)
check_route_continuity(uploaded_file)